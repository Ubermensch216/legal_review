...
export const PROMPT_VERSION = 'r5';
...
const PRESET_FOCUS = {
  contract_risk: '계약 문언으로 확인되는 부담과 실제 효력 판단을 분리한다. 과업변경·위약·해지·책임·지식재산·인력지휘·분쟁절차·대금지급 및 필요한 조항의 부재를 살핀다. 약관성·기관 유형 등 미확정 전제를 단정하지 않는다.',
  ...
  privacy_security: '스프레드시트의 각 행을 빠짐없이 독립 쟁점으로 세우고 해당 행의 문서 사실 ID를 연결한다. 각 행에서 수집·이용·제공·위탁·보관·파기와 민감정보·고유식별정보 쟁점을 살핀다. 행의 문언상 위험과 법적 위반 확정은 구분한다.',
