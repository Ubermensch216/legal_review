...
export function buildReviewInput(context, documentText = '', query = '') {
  const evidence = context.officialEvidence || {};
  const document = context.reviewContext?.document || optimizeDocumentContext({ documentText, query, maxChars: 4500 });
