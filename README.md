...
└────────────────────────────┬──────────────────────────────┘
         ...
         ▼                   ▼                   ▼                   ▼
┌─────────────────┐ ┌─────────────────┐ ┌─────────────────┐ ┌─────────────────┐
│  [1. 검토 초안] │ │ [2. 법령 & 근거]│ │ [3. 충돌·영향]  │ │[4. 공식의견서(핵심)]
│  - 리스크 분석표│ │ - 현행 조문 전문│ │ - 조문 충돌 분석│ │ - 완성형 공문서뷰│
│  - 심층의견 카드│ │ - 판례/해석례   │ │ - 신구 조문 Diff│ │ - 빠른 HWPX/PDF │
│  - 보완 조치계획│ │ - 전문용어 KB   │ │ - 제재 리스크표 │ │ - 스튜디오 에디터│
└─────────────────┘ └─────────────────┘ └─────────────────┘ └─────────────────┘
```
...
3. **정형화 UI 렌더링**:
   - 마크다운 기호를 배제하고 **[핵심 쟁점 및 법적 리스크 분석표]**, **[심층 법률 검토의견 카드]**, **[보완 권고사항 체크리스트]**, **[관련 법령 및 적용 조문 근거표(하단 배치)]**로 나누어 시각화합니다.

### 탭 2: [2. 공식 법령 & 근거] 작성 원리
...
### 탭 4: [4. 공식 법률검토의견서 (최종 결론)] 작성 원리
1. **공문서 표준 서식 자동 조판**:
   - 상단 공문서 메타 정보(문서번호, 일자, 대상, 주요법령) ➔ 1.검토 배경 ➔ 2.법률적 쟁점 및 심층 검토의견 ➔ 3.리스크 및 보완조치 ➔ 4.관련 법령 및 조문 근거표 ➔ 면책문구 순서로 정식 결재용 공문서를 자동 구성합니다.
2. **원클릭 빠른 내보내기 툴바**:
   - 탭 상단에서 **[HWPX]**, **[PDF]**, **[DOCX]** 다운로드 및 **[보고서 스튜디오에서 편집]**을 즉시 실행할 수 있습니다.
3. **시각적 강조 탭 UI**:
   - 최종 결론이자 핵심 산출물이므로 네이비 하이라이트 배지와 특별 탭 디자인으로 시각적 중요도를 명확히 강조합니다.
